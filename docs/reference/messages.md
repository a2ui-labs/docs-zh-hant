...
| ---------------------- | -------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| 找不到 Surface         | `surfaceId` 不存在                     | 確保同一個 surface 一直使用唯一的 `surfaceId`。surface 會在第一次更新時隱式建立。                                      |
...
=== "v0.8"
    ...
    - **[server_to_client.json](https://a2ui.org/specification/v0_8/server_to_client.json)**: 訊息信封架構
    - **[standard_catalog_definition.json](https://a2ui.org/specification/v0_8/standard_catalog_definition.json)**: 元件架構

=== "v0.9"

    依下列內容驗證：

    - **[server_to_client.json](https://a2ui.org/specification/v0_9/server_to_client.json)**: 訊息信封架構
    - **[basic_catalog.json](https://a2ui.org/specification/v0_9/basic_catalog.json)**: 元件架構
