...
在 [`rizzcharts`](../../samples/agent/adk/rizzcharts/python/README.md) 範例中，catalog schema 定義在 [`rizzcharts_catalog_definition.json`](../../samples/agent/adk/rizzcharts/catalog_schemas/0.9/rizzcharts_catalog_definition.json)。
...
在 [`rizzcharts`](../../samples/client/angular/projects/rizzcharts/README.md) 範例中，`Chart` 元件定義在 [`chart.ts`](../../samples/client/angular/projects/rizzcharts/src/a2ui-catalog/chart.ts)。
...
在 [`rizzcharts`](../../samples/agent/adk/rizzcharts/python/README.md) 範例中，這在 [`catalog.ts`](../../samples/client/angular/projects/rizzcharts/src/a2ui-catalog/catalog.ts) 中完成。
...
Agent 使用 [SendA2uiToClientToolset](../../agent_sdks/python/src/a2ui/adk/send_a2ui_to_client_toolset.py) 獲得一個可用於向客戶端送出 A2UI 的工具。
...
LLM 對 [SendA2uiToClientToolset](../../agent_sdks/python/src/a2ui/adk/send_a2ui_to_client_toolset.py) 中工具的呼叫，會在 A2A Agent Executor 中透過 [A2uiEventConverter](../../agent_sdks/python/src/a2ui/adk/send_a2ui_to_client_toolset.py) 被攔截。這會自動把工具呼叫轉換為帶有 A2UI payload 的 A2A DataPart。
