...
- **Node.js**（v18 或更新版本）— [下載連結](https://nodejs.org/)
...
這個示例展示了一個聯絡人查詢智慧體，它會生成搜尋表單與結果列表。
...
如果瀏覽器開啟時看到 `ERR_CONNECTION_REFUSED`，**不用擔心**。這是一個已知的競態問題（[#587](https://github.com/google/A2UI/issues/587)）。Web 應用啟動速度比 Python 智慧體後端更快。等待幾秒後重新整理頁面即可。
...
- 閱讀 [samples/client/lit/README.md](https://github.com/google/a2ui/tree/main/samples/client/lit)
- 參與社群討論
