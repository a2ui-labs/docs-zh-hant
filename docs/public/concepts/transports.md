...
| **AG-UI** | ✅ 穩定 | 全端 React、Vue、Angular 應用（CopilotKit） |
...
[AG-UI](https://ag-ui.com/) 會自動把 A2UI 訊息轉換成 AG-UI 事件，並處理傳輸與狀態同步。它常用於全端 React、Vue、Angular 應用。CopilotKit 是 AG-UI 的創建者，也是它的主要使用方。

**另見：** [在任意 Agent 框架中使用 A2UI（透過 AG-UI）](../guides/a2ui-with-any-agent-framework.md)：設定 CopilotKit 搭配你選定的智慧體框架，並啟用 A2UI 渲染。
