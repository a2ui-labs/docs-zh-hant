...
| **ADK** | 📋 規劃中 | 仍在設計開發者體驗，可參考 [samples](https://github.com/google/A2UI/tree/main/samples/agent/adk) |
| **Genkit** | 💡 提議中 | 社群有興趣 |
| **LangGraph** | 💡 提議中 | 社群有興趣 |
| **CrewAI** | 💡 提議中 | 社群有興趣 |
| **AG2** | 💡 提議中 | 社群有興趣 |
...
- 在 [GitHub Discussions](https://github.com/google/A2UI/discussions) 中 **提出功能建議**
- **建立原型** 並與社群分享
- 在 GitHub Issues 中 **加入討論**

## 持續關注

- Watch [GitHub 倉庫](https://github.com/google/A2UI) 以接收更新
- Star 倉庫以表達支持
...
對路線圖有問題嗎？歡迎在 [GitHub](https://github.com/google/A2UI/discussions) 發起討論。
